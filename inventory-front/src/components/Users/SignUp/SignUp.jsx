...
import { SignUpEmailVerifyRequest } from "../../../ApiServices/UsersAPIRequest";
import {
  setFirstName,
  setLastName,
  setMobile,
...
const SignUp = (props) => {
  ...
  const onRegistration = async () => {
    ...
    if (IsEmpty(email)) {
      ...
      let Result = await SignUpEmailVerifyRequest(email, SignUpBtnRef);
      if (Result === true) {
        setRegEmail(email);
                  ...
                  <div className="row m-0 p-0">
                    <div className="col-md-4 p-2">
                      ...
                      <input
                        ...
                        className="form-control animated fadeInUp formInput"
                        type="email"
                      />
                    </div>
                    <div className="col-md-4 p-2">
                  ...
                  <div className="row mt-2 p-0">
                    <div className="col-md-4 p-2">
                      <button
                        ...
                        ref={(button) => (SignUpBtnRef = button)}
                        className="btn btn-success mt-3 w-100 float-end animated fadeInUp"
                      >
                        SIGN UP
                      </button>
                    </div>
