...
import {DeleteExpenseTypeRequest, ExpenseTypeListRequest} from "../../ApiServices/ExpenseTypeApiRequest";
import {selectExpenseTypeList, selectExpenseTypeListTotal} from "../../redux/state-slice/expensetypeSlice";
...
const ExpenseTypeList = () => {
    ...
    let DataList=useSelector(selectExpenseTypeList);
    let Total=useSelector(selectExpenseTypeListTotal);
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item,i)=>
                                                            <tr key={i.toString()}>
                                                                ...
                                                                <td><p className="text-xs text-start">{item.TypeName}</p></td>
                                                                <td><p className="text-xs text-start">{moment(item.CreatedDate).format('MMMM Do YYYY')}</p></td>
                                                                <td>
                                                                    <Link to={`/ExpenseTypeUpdatePage/${item._id}`} className="btn text-info btn-outline-light p-2 mb-0 btn-sm">
