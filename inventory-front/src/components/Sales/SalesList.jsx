...
import {SaleDeleteRequest, SaleListRequest} from "../../ApiServices/SaleApiRequest";
import {selectSaleList, selectSaleListTotal} from "../../redux/state-slice/saleSlice";
...
const SalesList = () => {
    ...
    let DataList=useSelector(selectSaleList);
    let Total=useSelector(selectSaleListTotal)
    ...
    const DeleteItem = async (id) => {
        ...
        if(Result.isConfirmed ===true){
            let DeleteResult= await SaleDeleteRequest(id);
