...
import {selectReturnList, selectReturnListTotal} from "../../redux/state-slice/returnSlice";
import {ReturnDeleteRequest, ReturnListRequest} from "../../ApiServices/ReturnApiRequest";
...
const ReturnList = () => {
    ...
    let DataList=useSelector(selectReturnList);
    let Total=useSelector(selectReturnListTotal)
    ...
    const DeleteItem = async (id) => {
        ...
        if(Result.isConfirmed ===true){
            let DeleteResult= await ReturnDeleteRequest(id);
                                                ...
                                                <table className="table ">
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item,i)=>
                                                            <tr key={i.toString()}>
                                                                <td>
                                                                    <p className="text-xs text-start">{item.CustomerName}</p>
                                                                </td>
