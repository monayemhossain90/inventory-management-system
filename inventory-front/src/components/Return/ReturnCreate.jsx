...
import {
    ...
    selectReturnItemList,
    SetReturnItemList
} from "../../redux/state-slice/returnSlice";
import {CreateReturnRequest, CustomerDropDownRequest, ProductDropDownRequest} from "../../ApiServices/ReturnApiRequest";
...
const ReturnCreate = () => {
    ...
    let ReturnItemList = useSelector(selectReturnItemList);
    ...
    const CreateNewReturn=async () => {
        ...
        if(ReturnItemList.length===0){
            ...
            let result= await CreateReturnRequest(Parent, ReturnItemList,ProcessingBtnRef);
            if(result===true){
                store.dispatch(ClearReturnItemList([]));
                            ...
                            <div className="card-body">
                                ...
                                <div className="row">
                                    <div className="col-4 p-2">
                                        <button onClick={CreateNewReturn} ref={(button)=>ProcessingBtnRef=button} className="btn btn-lg my-3 btn-success">Create</button>
                                    </div>
                                </div>
                            </div>
                        </div>
