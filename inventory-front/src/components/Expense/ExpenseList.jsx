...
import {DeleteExpenseRequest, ExpenseListRequest} from "../../ApiServices/ExpenseApiRequest";
import {selectExpenseList, selectExpenseListTotal} from "../../redux/state-slice/expenseSlice";
...
const ExpenseList = () => {
    ...
    let DataList=useSelector(selectExpenseList);
    let Total=useSelector(selectExpenseListTotal);
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item,i)=>
                                                            <tr key={i.toString()}>
                                                                ...
                                                                <td>
                                                                    <Link to={`/ExpenseUpdatePage/${item._id}`} className="btn text-info btn-outline-light p-2 mb-0 btn-sm">
