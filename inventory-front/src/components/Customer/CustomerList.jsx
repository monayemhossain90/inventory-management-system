...
import {CustomerListRequest, DeleteCustomerRequest} from "../../ApiServices/CustomerApiRequest";
import {selectCustomerList, selectCustomerListTotal} from "../../redux/state-slice/customerSlice";
...
const CustomerList = () => {
    ...
    let Total=useSelector(selectCustomerListTotal);
                                                    ...
                                                    <tbody>
                                                    {
                                                        DataList.map((item,i)=>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <Link to={`/CustomerUpdatePage/${item._id}`} className="btn text-info btn-outline-light p-2 mb-0 btn-sm">
